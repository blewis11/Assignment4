...
print "<p> ------------------------------------</p>"
print "<img src=http://3.bp.blogspot.com/-ZVGjMlaHu0A/TVWIl3pwYWI/AAAAAAAAFkQ/Khtw_rTbsz4/s400/homer.bmp style=width:500px;height:500px>"
print "<br><br><br>"
print "<p> Thank you very much for your order, click the link to confirm and go back to the home page! </p>"
print "<br><br><a href= 'index.html' > Continue </a>"
print "</center>"
print "</body>"
print "</html>"
